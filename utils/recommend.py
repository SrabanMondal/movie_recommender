...
plot_embeddings = np.load('data/plot_embeddings.npz', mmap_mode='r')['arr_0']
genre_embeddings = np.load('data/genre_embeddings.npz', mmap_mode='r')['arr_0']
topic_embeddings = np.load('data/topic_embeddings.npz', mmap_mode='r')['arr_0']
...
def recommend(
    ...
    return result[["title", "score", "lan", "genres", "plot","ratings","final_score"]].to_dict(orient="records")
...
def recommend_from_users(
    ...
    return result[["title", "ratings", "lan", "genres", "plot", "freq_score","final_score"]].to_dict(orient="records")
